...
TLDS1 will first generate Digest based on the challange and the key and return that to AUTH Server.
Then BAsed on the MAtch TLDS will recive a client request and 
TLDS1 server will look for the information and 
IF TLDS1 server has information it will return info with a flag A.
else return HOSTname Error.

TO RUN TLDS1 Server Type: python3 TLDS1.py 
...
def server():
    ...
    # creating Disctionary of DNS information from PROJ3-TLDS1.txt file. 
    ...
    while (True):
        ...
        if (data_from_client=='open'):
            ...
            if data_from_client in TSDNS_tabel:
                ...
                seradd="HOSTNAME ERROR: HOST NOT FOUND IN TLDS1. "
